...
export default async function AdminBillingPage() {
  ...
  const cards = [
    ...
    { label: 'Annual Run Rate', value: `$${(mrr * 12).toLocaleString()}`, sub: 'MRR × 12', icon: TrendingUp, color: 'text-green-400' },
    { label: 'Pro Subscribers', value: c.pro, sub: `of ${c.total} users`, icon: Crown, color: 'text-green-800' },
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Revenue from Pro subscriptions.</p>
      </div>
      ...
      <section className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide px-5 py-4 border-b border-gray-200">
          Paying Customers
        </h2>
      ...
      <p className="text-xs text-gray-600">
        Set the Pro price with the <code className="bg-gray-100 px-1 rounded">PRO_PLAN_PRICE</code> backend env var.
