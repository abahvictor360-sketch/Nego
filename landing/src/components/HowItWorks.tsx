const steps = [
  {
    ...
    desc: 'Set a public list price and a private floor price. The floor is stored server-side — the AI never sees it.',
    icon: '📦',
  },
  {
    n: '02',
    title: 'Embed the Widget',
    desc: 'Drop one script tag onto your store page. Nego Bot\'s chat bubble appears instantly, ready to negotiate.',
    icon: '🔌',
  },
  {
    n: '03',
    title: 'Deals Close Automatically',
    desc: 'The AI haggles with your customers, protects your margin, then redirects them to a signed checkout URL.',
    icon: '🤝',
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            No AI expertise required. Set your prices, embed the widget, and watch deals flow in.
          </p>
        </div>
            ...
            <div key={i} className="flex flex-col md:flex-row items-center flex-1">
              <div className="bg-white rounded-2xl border border-gray-100 p-8 w-full shadow-sm feature-card">
                <div className="flex items-start gap-4">
                  <div className="shrink-0 w-12 h-12 rounded-xl bg-violet-50 flex items-center justify-center text-2xl">
                    {step.icon}
                  </div>
                  <div>
...
{`<div
  ...
  data-nego-api-url="https://api.negotiobot.com"
></div>
<script src="https://cdn.negotiobot.com/nego-widget.umd.js"></script>`}
          </pre>
