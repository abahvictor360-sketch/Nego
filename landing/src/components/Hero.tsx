...
export default function Hero({ content }: { content: HeroContent }) {
  ...
  return (
    <section className="hero-gradient pt-32 pb-20 px-6 relative overflow-hidden">
      {/* Radial glow blobs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[600px] bg-green-100 rounded-full blur-[120px] opacity-40 pointer-events-none" />
      <div className="absolute top-20 left-10 w-64 h-64 bg-green-200 rounded-full blur-[80px] opacity-20 pointer-events-none" />
      <div className="absolute top-10 right-10 w-80 h-80 bg-green-100 rounded-full blur-[100px] opacity-30 pointer-events-none" />

      <div className="max-w-7xl mx-auto relative">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">

          {/* Announcement badge */}
          <div className="badge inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium text-green-700 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-16">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-7 py-3.5 rounded-full hover:bg-green-700 transition-all shadow-lg shadow-green-200 hover:shadow-green-300 hover:-translate-y-0.5"
            >
              {content.cta_primary}
            ...
            <a
              href="/demo"
              className="inline-flex items-center justify-center gap-2 bg-white text-gray-700 font-semibold px-7 py-3.5 rounded-full border border-gray-200 hover:border-green-300 hover:text-green-600 transition-all hover:-translate-y-0.5"
            >
          ...
          <div className="relative w-full max-w-3xl h-64 sm:h-72">
            ...
            <div className="glass rounded-2xl p-4 shadow-xl shadow-green-100 absolute left-1/2 -translate-x-1/2 top-4 w-64 animate-float">
              ...
              <div className="space-y-1.5">
                <div className="bg-green-50 rounded-xl rounded-tl-sm px-3 py-2">
                ...
                <div className="flex gap-1 px-3 py-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-400 dot1" />
                  <span className="w-1.5 h-1.5 rounded-full bg-green-400 dot2" />
                  <span className="w-1.5 h-1.5 rounded-full bg-green-400 dot3" />
                </div>
              </div>
            </div>
            ...
            <div className="glass rounded-2xl p-4 shadow-lg absolute left-0 sm:left-4 top-8 w-52 animate-float2">
              ...
              <div className="space-y-1">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-bold text-green-600">$318</span>
                </div>
              ...
              <div className="mt-3 bg-green-600 text-white text-xs font-semibold flex items-center justify-center gap-1 py-1.5 rounded-lg">
            ...
            <div className="glass rounded-2xl p-4 shadow-lg absolute right-0 sm:right-4 top-12 w-52 animate-float3">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600"><Shield className="w-3.5 h-3.5" /></div>
